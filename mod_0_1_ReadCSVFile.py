                    ...
                    for CompanyEmail in CompanyEmails:
                        if CompanyEmail not in CompanyEmailsAdded:
                            ...
                            CompanyContact = {
                                ...
                                'LinkedInProfile': '',
                                'CompanyAreasOfInvestmentInterest': FirstContact.get('CompanyAreasOfInvestmentInterest', ''),
                                'YearFounded': FirstContact.get('YearFounded', ''),
                                'AUM_USD_MIL_UnlessNoted': FirstContact.get('AUM_USD_MIL_UnlessNoted', ''),
                                'ClientAvg': FirstContact.get('ClientAvg', ''),
                                'ClientMin': FirstContact.get('ClientMin', ''),
                                'AdditionalCompanyContactInfo': FirstContact.get('AdditionalCompanyContactInfo', ''),
                                'Website': FirstContact.get('Website', ''),
                                'Etc': FirstContact.get('Etc', ''),
                                'MF/SF': FirstContact.get('MF/SF', ''),
                                'NewOffice': FirstContact.get('NewOffice', '')
                            }
